...
class MaskRCNN(object):
    ...
    def compile(self, learning_rate, momentum, OPTIMIZER):
        ...
        if OPTIMIZER == 'SGD':
            print('using SGD with exponential decay as optimizer function..............................')
            optimizer = keras.optimizers.SGD(
                learning_rate=lr_schedule, momentum=momentum, clipnorm=self.config.GRADIENT_CLIP_NORM)
        elif OPTIMIZER == 'Adamdelta':
            print('using Adamdelta as optimizer function................................................')
            optimizer = keras.optimizers.Adadelta(
                learning_rate=learning_rate, rho=0.95, epsilon=1e-07, clipnorm=self.config.GRADIENT_CLIP_NORM)
        else:
            print('using Adam as optimizer function................................................')
            optimizer = keras.optimizers.Adam(
                learning_rate, beta_1=0.9, beta_2=0.999, epsilon=1e-07, amsgrad=False, clipnorm=self.config.GRADIENT_CLIP_NORM)
    ...
    def train(self, train_dataset, val_dataset, learning_rate, OPTIMIZER, epochs, layers,
              augmentation=None, custom_callbacks=None, no_augmentation_sources=None, save_best_only=False, period=10):
        """Train the model.
        ...
        if save_best_only:
            ...
            callbacks = [
                keras.callbacks.TensorBoard(log_dir=self.log_dir,
                                            histogram_freq=0, write_graph=True, write_images=False),
                keras.callbacks.ModelCheckpoint(self.checkpoint_path,
                                                verbose=0, save_weights_only=True, period=period),
            ]
